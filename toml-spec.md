...
URL Source: https://toml.io/en/v1.0.0

Markdown Content:
Published on 1/11/2021 – [Text version](https://raw.githubusercontent.com/toml-lang/toml.io/main/specs/en/v1.0.0.md)

Tom's Obvious, Minimal Language.

By Tom Preston-Werner, Pradyun Gedam, et al.

## [Objectives](https://toml.io/en/v1.0.0#objectives)

TOML aims to be a minimal configuration file format that's easy to read due to obvious semantics. TOML is designed to map unambiguously to a hash table. TOML should be easy to parse into data structures in a wide variety of languages.

## [Spec](https://toml.io/en/v1.0.0#spec)
...
## [Key/Value Pair](https://toml.io/en/v1.0.0#keyvalue-pair)
...
## [Keys](https://toml.io/en/v1.0.0#keys)
...
## [MIME Type](https://toml.io/en/v1.0.0#mime-type)

When transferring TOML files over the internet, the appropriate MIME type is `application/toml`.

## [ABNF Grammar](https://toml.io/en/v1.0.0#abnf-grammar)
